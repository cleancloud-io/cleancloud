...
cleancloud --version  # should show 1.6.2 or later
```
...
```bash
cleancloud --version
# Should show 1.6.2 or later — earlier versions have known issues
```

If you see a version older than 1.6.2, run `pip uninstall cleancloud` first, then re-run `pipx install cleancloud`.
